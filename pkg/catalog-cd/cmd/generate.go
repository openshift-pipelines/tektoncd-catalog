...
import (
	...
	"github.com/openshift-pipelines/tektoncd-catalog/pkg/catalog-cd/catalog"
	"github.com/openshift-pipelines/tektoncd-catalog/pkg/catalog-cd/config"
	fc "github.com/openshift-pipelines/tektoncd-catalog/pkg/catalog-cd/fetcher/config"
